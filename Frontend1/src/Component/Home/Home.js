					...
					<ul className="slides">
						<li>
							<div className="container">
								...
								<div className="slide-caption">
									<h2 className="slide-title">Duis aute reprehenderit</h2>
									<small className="slide-subtitle">Nemo enom ipsam voluptatem voluptas</small>
						...
						<li>
							<div className="container">
								<img src={animation1} alt=""/>
								<div className="slide-caption">
									<h2 className="slide-title">Rerehenderit aute duis consetetur</h2>
									<small className="slide-subtitle">Ipsam voluptas nemo enim</small>
									<div className="slide-summary">
						...
						<li>
							<div className="container">
								<img src={animation1} alt=""/>
								<div className="slide-caption">
									<h2 className="slide-title">Aliqquam nibh quam iaculis</h2>
									<small className="slide-subtitle">Augue dui fringilla ipsum hendrerit felis accumsan</small>
									<div className="slide-summary">
						...
						<div className="row">
							<div className="col-md-4">
								<div className="feature wow fadeInUp">
									...
									<Link to="/policy/health" className="button">More info</Link>
								</div> 
							</div>
							<div className="col-md-4">
								<div className="feature wow fadeInUp" data-wow-delay=".2s">
									...
									<Link to="/policy/home" className="button">More info</Link>
								</div> 
							</div> 
							<div className="col-md-4">
								<div className="feature wow fadeInUp" data-wow-delay=".4s">
									...
									<Link to="/policy/vehicle" className="button">More info</Link>
								</div>
							</div>
						</div>
					</div> 
					...
					<div className="container">
						...
						<div className="row">
							...
							<div className="col-md-6">
								<h2 className="wow fadeInRight">What can you expect?</h2>
					...
					<div className="row">
						<div className="col-md-6">
							...
							<div className=" branding">
								<img src={logoFooter} alt="Site title" className="logo-icon"/>
								<h1 className="site-title"><Link to="#">Company <span>Name</span></Link></h1> 
								<h2 className="site-description">Tagline goes here</h2>
							</div> 

							<p className="copy">Copyright 2014 Company name. designed by Themezy. All rights reserved</p>
						</div>
